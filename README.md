...
The game includes 5v5 demolition, a first-to-30 free-for-all against 20 active bots, a reusable four-target training range, side swap, an AKM rifle, 9mm pistol, and procedural karambit, economy and armor, two bomb sites, grenades, minimap, kill feed, configurable difficulty, audio, touch controls, and locally saved career stats. Weapon-only viewmodels include sway, recoil, reload motion, muzzle flash, tracers, ejected casings, melee attacks, and a full karambit inspection flip. Eliminated players collapse directionally and remain visible until their mode respawns or resets them. Free-for-all respawns include brief spawn protection; pause freezes the simulation; mobile controls include jump, weapon cycling, and an always-accessible menu.
